...
const SITE_URL = 'https://monitoringsituation.lol/';
...
const X_HANDLE = '@MonitorMeme_RH';
const X_URL = 'https://x.com/MonitorMeme_RH';
const SOURCE_URL = 'https://github.com/Lighteros/Monitor-Meme';
const LICENSE_URL = 'https://github.com/Lighteros/Monitor-Meme/blob/main/LICENSE';
...
console.log('[monitor-postbuild] Prepared monitoringsituation.lol production output.');
