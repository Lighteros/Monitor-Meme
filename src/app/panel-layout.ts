...
const DASHBOARD_REFERENCE_LINKS = [
  { label: 'X', url: 'https://x.com/MonitorMeme_RH' },
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header" role="banner">
        <div class="header-left">
          ...
          <a href="https://x.com/MonitorMeme_RH" target="_blank" rel="noopener noreferrer" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@MonitorMeme_RH</span>
          </a>
      ...
      <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
        ...
        <a class="mobile-menu-item" href="https://x.com/MonitorMeme_RH" target="_blank" rel="noopener noreferrer">
          ...
          <span class="mobile-menu-item-label">@MonitorMeme_RH</span>
        </a>
        <div class="mobile-menu-divider"></div>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          <div class="site-footer-brand-text">
            ...
            <span class="site-footer-sub"><button type="button" class="monitor-contract-copy" title="Copy full contract address" aria-label="Copy MONITOR contract address">0xcomingsoon</button> &middot; <a href="https://x.com/MonitorMeme_RH" target="_blank" rel="noopener noreferrer" class="site-footer-credit">@MonitorMeme_RH</a></span>
          </div>
        </div>
